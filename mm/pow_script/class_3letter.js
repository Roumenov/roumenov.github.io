    ...
    for(var p = 0; p < this.points.length; p++){
      for(var m = 0; m < this.module[p].length; m++){
        ...
        if(this.ticker[p][m] < 0){
          ...
          this.module[p][m].xPHactual = map(easeOutQuart(tk0), 0, 1, this.module[p][m].xPre, this.module[p][m].xPH);
          this.module[p][m].yPHactual = map(easeOutQuart(tk0), 0, 1, this.module[p][m].yPre, this.module[p][m].yPH);
          this.module[p][m].xHactual = map(easeOutQuart(tk0), 0, 1, this.module[p][m].x, this.module[p][m].xH);
          this.module[p][m].yHactual = map(easeOutQuart(tk0), 0, 1, this.module[p][m].y, this.module[p][m].yH);

          // this.module[p][m] = p5.Vector.lerp(this.anchs[p][m], this.handsTarget[p][m], easeOutQuart(tk0));
        } else if(this.ticker[p][m] < this.animWindow2[m]){
          var tk0 = map(this.ticker[p][m], this.animWindow, this.animWindow2[m], 0, 1);

          this.module[p][m].xPHactual = map(easeInQuart(tk0), 0, 1, this.module[p][m].xPH, this.module[p][m].xPre);
          this.module[p][m].yPHactual = map(easeInQuart(tk0), 0, 1, this.module[p][m].yPH, this.module[p][m].yPre);
          this.module[p][m].xHactual = map(easeInQuart(tk0), 0, 1, this.module[p][m].xH, this.module[p][m].x);
          this.module[p][m].yHactual = map(easeInQuart(tk0), 0, 1, this.module[p][m].yH, this.module[p][m].y);
      ...
      for(var m = 0; m < this.burst[p].length; m++){
        ...
        if(this.ticker[p][m] < 0){
          ...
          this.burst[p][m].x1mover = map(easeOutQuart(tk0), 0, 1, this.burst[p][m].x1start, this.burst[p][m].x1end);
          this.burst[p][m].y1mover = map(easeOutQuart(tk0), 0, 1, this.burst[p][m].y1start, this.burst[p][m].y1end);
          this.burst[p][m].x2mover = map(easeOutQuart(tk0), 0, 1, this.burst[p][m].x2start, this.burst[p][m].x2end);
          this.burst[p][m].y2mover = map(easeOutQuart(tk0), 0, 1, this.burst[p][m].y2start, this.burst[p][m].y2end);
        } else if(this.ticker[p][m] < this.animWindow3){
          var tk0 = map(this.ticker[p][m], this.animWindow, this.animWindow2, 0, 1);

          this.burst[p][m].x1mover = map(easeInQuart(tk0), 0, 1, this.burst[p][m].x1end, this.burst[p][m].x1start);
          this.burst[p][m].y1mover = map(easeInQuart(tk0), 0, 1, this.burst[p][m].y1end, this.burst[p][m].y1start);
          this.burst[p][m].x2mover = map(easeInQuart(tk0), 0, 1, this.burst[p][m].x2end, this.burst[p][m].x2start);
          this.burst[p][m].y2mover = map(easeInQuart(tk0), 0, 1, this.burst[p][m].y2end, this.burst[p][m].y2start);
        }
      }
    }
  }
